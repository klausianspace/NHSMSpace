          ...
          <div className="bg-dark-lighter/30 rounded-xl border border-white/10 p-12 max-w-3xl mx-auto">
            <div className="text-center py-12">
              <div className="flex justify-center mb-6">
                <div className="relative">
                  <div className="w-24 h-24 rounded-full bg-accent/10 flex items-center justify-center">
                    <Calendar className="w-12 h-12 text-accent" strokeWidth={1.5} />
                  </div>
              ...
              <p className="text-xl text-white/80 mb-6">
                We're curating our upcoming seminars, hackathons, and conferences.
              </p>
              ...
              <p className="text-white/60">
                Check back soon for our exciting event calendar.
              </p>
            </div>
          </div>
        </div>
