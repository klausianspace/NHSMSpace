...
import { FlaskRound as Flask, Clock } from 'lucide-react';
import Footer from '../components/Footer';

const Clubs = () => {
  React.useEffect(() => {
    document.title = 'NHSM Space - Scientific Clubs';
  }, []);
    ...
    <main className="page-content min-h-screen">
      <div className="container mx-auto px-4 mb-20">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-serif font-bold gradient-text mb-4">Scientific Clubs</h1>
          <div className="bg-dark-lighter/30 rounded-xl border border-white/10 p-12 max-w-3xl mx-auto">
            <div className="text-center py-12">
              <div className="flex justify-center mb-6">
                <div className="relative">
                  <div className="w-24 h-24 rounded-full bg-accent/10 flex items-center justify-center">
                    <Flask className="w-12 h-12 text-accent" strokeWidth={1.5} />
                  </div>
              ...
              <p className="text-xl text-white/80 mb-6">
                We're preparing exciting content about Finmatics, Mobius, and Eurika clubs.
              </p>
              ...
              <p className="text-white/60">
                Check back soon to explore our scientific community.
              </p>
            </div>
          </div>
        </div>
